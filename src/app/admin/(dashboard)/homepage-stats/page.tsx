  ...
  return (
    <div>
      ...
      <p className="text-text-secondary mt-2 max-w-2xl text-sm">
        اعداد و برچسب‌هایی که در هیرو صفحه اصلی با انیمیشن شمارش نمایش داده می‌شوند: آمار اول، آمار
        دوم و آمار سوم. این مقادیر دستی هستند و از دیتابیس محاسبه نمی‌شوند. تا وقتی ذخیره نکرده
        باشید، بخش آمار در سایت نشان داده نمی‌شود.
      </p>
      {saved === "1" ? (
