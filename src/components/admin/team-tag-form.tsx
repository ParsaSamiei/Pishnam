...
import type { TeamTagFormState } from "@/app/admin/(dashboard)/team-tags/actions";

interface TeamTagFormProps {
  action: (prevState: TeamTagFormState, formData: FormData) => Promise<TeamTagFormState>;
  defaultValues?: {
    slug: string;
    nameFa: string;
    nameEn: string;
...
const initialState: TeamTagFormState = { status: "idle" };

export function TeamTagForm({ action, defaultValues, submitLabel }: TeamTagFormProps) {
