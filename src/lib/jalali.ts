/**
 * Jalali (Persian) calendar helpers based on the jalaali-js algorithm.
 * Used by admin date fields so staff can pick dates in the calendar they use daily.
 */
...
/** Parse a Gregorian `YYYY-MM-DD` string into Jalali parts, or null if empty/invalid. */
...
/** Convert Jalali parts to a Gregorian `YYYY-MM-DD` string. */
