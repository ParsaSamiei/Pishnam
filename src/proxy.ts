...
// Locale routing only. This file MUST live at src/proxy.ts, not at the
// project root -- Next.js requires proxy to be colocated with src/
...
// proxy for actual protection -- keeping proxy single-purpose
